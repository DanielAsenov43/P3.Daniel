...
3. `git clone https://github.com/DanielAsenov43/P3.Daniel`
4. Abrir laragon u otro sistema que soporte PHP y MySQL
5. Buscar `localhost` en la web (o `127.0.0.1:80`)
